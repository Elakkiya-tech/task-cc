...
<h3>To create a Domain ID and to enable the common drive access as mentioned below</h3><br />
          ...
          <div className="Req-Date">
            <form>
            <label style={{}}>Request Date</label>
 ...
   <option value="option 2">Temporary</option>
          ...
          <div className="sign-content-2">
              <img src={profileImages} alt="" id="image-sign-content-2" className="images-content" style={{marginLeft:"850px",width:"130px",height:"115px",position:"relative", top:"-118px"}}/> </div>
          ...
          <div className="label-content">
              <label htmlFor="in" className="image-upload-content"  style={{width:"500px",height:"115px",position:"relative",top:"-110px",left:"770px"}}
 >Requestor Signature</label>
          ...
          <div className="sign-content-3">
              <img src={proImg} alt="" id="image-sign-content-3" className="images-content-3" style={{marginLeft:"850px",width:"130px",height:"115px", position:"relative", top:"-115px"}}/> </div>
          ...
          <div className="label-content-3">
              <label htmlFor="inputsign" className="image-upload-content-3"  style={{width:"500px",height:"115px",position:"relative",left:"780px",top:"-90px"}}
 >Reporting to Manager Signature</label>
          ...
          <div className="sign-content-4">
              <img src={signImg} alt="" id="image-sign-content-4" className="images-content-4" style={{marginLeft:"850px",width:"130px",height:"115px",position:"relative",top:"85px"}}/> </div>
          ...
          <div className="label-content-4">
              <label htmlFor="inputsign4" className="image-upload-content-4"  style={{left:"780px",width:"180px",height:"115px",position:"relative",top:"105px"}}
