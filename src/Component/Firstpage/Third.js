...
by me will render me liable to dismissal from service, if appointed.</label>
            ...
            <div className="image-sign">
              <img src={profileImgs} alt="" id="imgs-sign" className="imgs-sign" style={{marginLeft:"150px",width:"130px", height:"120px", position:"relative", top:"-84px"}} 
/>
          </div>
          ...
          <div className="labels-sign">
              <label htmlFor="input-sign" className="image-uploader" style={{marginLeft:"410px",position:"relative",top:"-69px"}}>
