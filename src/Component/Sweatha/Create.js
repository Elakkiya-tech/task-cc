...
<h6 className="h6_contents"  >Personal conflict of interest</h6>
<p>
...
<h6 className="h6_contents" > Customer or Supplier Conflict of Interest</h6>
<p>
      ...
      <form>
        ...
        <div className="Name"> 
         ...
         <label style={{paddingLeft:"50px", left:"0px"}}>Employee Id:</label> 
           ...
           <div className="signs">     
          <div className="signs">
              <img src={Sign} alt="" id="image_sign_content" className="images_content" style={{width:"130px",height:"115px",marginLeft:"770px",position:"relative", top:"-125px"}}/> </div>
          ...
          <div className="label_content">
              <label htmlFor="in" className="image_upload_content"  style={{width:"130px", marginLeft:"950px",position:"relative",top:"-90px"}}
 >Signature</label>
          </div></div> 

<div className="Date1">   <label>
           Date:</label>
           
         <input type="date" className="date" style={{marginRight: "0px",marginTop: "0px",marginLeft: "52px", position:"relative",}}
          />
     ...
     <br/><br/>
       ...
       <div className="Next" style={{marginLeft:"50%"}}>
